...
class Buckets {
  ...
  static String getPreviewUrl(
    ...
    var url =
        '${AppwriteConfig.endpoint}/storage/buckets/$bucketId/files/$fileId/preview?project=${AppwriteConfig.projectId}';
...
class CollectionEnums {
  ...
  static const String tripEnroute = 'driver_enroute';
  ...
  // Notification Type (from notifications.type enum)
  ...
  static const String notifyTripStarted = 'trip_started';
  static const String notifyDriverArrived = 'driver_arrived';
  static const String notifyChildPicked = 'child_picked';
  static const String notifyChildDropped = 'child_dropped';
  static const String notifyRequestReceived = 'request_received';
  static const String notifyRequestAccepted = 'request_accepted';
  static const String notifyRequestRejected = 'request_rejected';
  static const String notifyNewMessage = 'new_message';
  ...
  // Geofence Event Type (from geofence_events.eventType enum)
  // Values: approaching_pickup, arrived_pickup, approaching_drop, arrived_drop, left_geofence
  static const String geofenceApproachingPickup = 'approaching_pickup';
  static const String geofenceArrivedPickup = 'arrived_pickup';
  static const String geofenceApproachingDrop = 'approaching_drop';
  static const String geofenceArrivedDrop = 'arrived_drop';
  static const String geofenceLeftGeofence = 'left_geofence';
