...
class DriverChatScreen extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Chat with parents will appear here when they contact you about trip updates',
  ...
  Widget _buildErrorState(DriverChatController ctrl) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
...
class _ChatListTile extends StatelessWidget {
  final DriverChatContact contact;
...
/// Contact avatar with unread indicator
