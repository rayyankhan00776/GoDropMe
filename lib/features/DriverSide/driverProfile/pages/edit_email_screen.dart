...
class DriverEditEmailScreen extends StatefulWidget {
  const DriverEditEmailScreen({super.key});

  @override
  State<DriverEditEmailScreen> createState() => _DriverEditEmailScreenState();
}

class _DriverEditEmailScreenState extends State<DriverEditEmailScreen> {
  ...
  Future<void> _saveEmail() async {
    if (_formKey.currentState?.validate() ?? false) {
      final email = _emailController.text.trim();
      await LocalStorage.setString(StorageKeys.driverEmail, email);
