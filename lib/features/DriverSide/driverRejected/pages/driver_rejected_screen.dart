...
/// Screen shown to drivers whose application has been rejected.
/// Displays rejection reason and option to re-apply or contact support.
class DriverRejectedScreen extends StatelessWidget {
  const DriverRejectedScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // Get rejection reason from route arguments if provided
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Subtitle
              Text(
                'We were unable to approve your driver application.',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'You can re-apply after addressing the issue or contact support for more information.',
                        style: AppTypography.helperSmall.copyWith(
                          color: AppColors.darkGray,
                          height: 1.4,
                        ),
