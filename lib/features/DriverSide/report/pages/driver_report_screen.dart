...
class _DriverReportScreenState extends State<DriverReportScreen>
  ...
  Widget _buildNewReportTab(DriverReportController ctrl) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          // Parent selection (optional - for reporting a specific parent)
          Text(
            'Report Parent (Optional)',
            style: AppTypography.helperSmall.copyWith(
              fontWeight: FontWeight.w600,
              color: AppColors.black,
            ),
          ...
          const SizedBox(height: 8),
          Obx(() {
            if (ctrl.isLoadingParents.value) {
              return Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  color: Colors.white,
            ...
            if (ctrl.availableParents.isEmpty) {
              return Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'No active parents found. You can still submit a general report.',
                        style: AppTypography.helperSmall.copyWith(
            ...
            return Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<ParentOption>(
                  value: ctrl.selectedParent.value,
                  isExpanded: true,
                  ...
                  items: [
                    ...
                    DropdownMenuItem<ParentOption>(
                      value: null,
                      child: Text(
                        'General Report (No specific parent)',
                        style: AppTypography.helperSmall.copyWith(
                          color: AppColors.gray,
                    ...
                    ...ctrl.availableParents.map((parent) {
                      return DropdownMenuItem<ParentOption>(
                        value: parent,
                        child: Row(
                          children: [
                            _ParentAvatar(
                  ...
                  onChanged: (value) => ctrl.selectParent(value),
                ),
              ),
            );
          }),
  ...
  Widget _buildMyReportsTab(DriverReportController ctrl) {
    return Obx(() {
...
/// Avatar widget for parent with AppwriteImage support
