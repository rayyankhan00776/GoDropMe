// Glassy Notification Button widget - reusable across parent side screens
...
class GlassNotificationButton extends StatefulWidget {
  ...
  @override
  State<GlassNotificationButton> createState() => _GlassNotificationButtonState();
}

class _GlassNotificationButtonState extends State<GlassNotificationButton> {
  @override
  void initState() {
    super.initState();
