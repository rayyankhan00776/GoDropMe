...
class ParentConversationScreen extends StatefulWidget {
  const ParentConversationScreen({super.key});

  @override
  State<ParentConversationScreen> createState() =>
      _ParentConversationScreenState();
}

class _ParentConversationScreenState extends State<ParentConversationScreen> {
  ...
  void _onScroll() {
    ...
    if (_scrollController.position.pixels >=
      ...
      final ctrl = Get.find<ParentConversationController>();
      ctrl.loadMore();
    }
  }
  ...
  bool _shouldShowDate(List<ParentChatMessage> messages, int index) {
  ...
  Widget _buildInputArea(ParentConversationController ctrl) {
    return SafeArea(
      top: false,
      child: Container(
...
class _MessageBubble extends StatelessWidget {
  final ParentChatMessage message;
  final bool isMe;
