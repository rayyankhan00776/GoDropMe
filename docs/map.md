# Map widgets and location buttons (extracted)

This file collects the exact code used in the app for the parent and driver map screens and their custom location buttons. The originals remain in place.

---

## Parent map screen: `ParentMapScreen`

Source: `lib/features/parentSide/parentHome/pages/parent_map_screen.dart`
...
## Driver map screen: `DriverMapScreen`

Source: `lib/features/driverSide/driverHome/pages/driver_map_screen.dart`
...
- Both screens disable the built-in Google Maps myLocationButton and use a custom round FAB (`_RoundFab`) positioned at bottom-left.
- Gesture recognizers include `EagerGestureRecognizer` so the map is responsive within drawer or scrollable shells.
